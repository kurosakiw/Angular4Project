...
<div *ngIf ="ifs==true" class="showBanner" style="background: url(../../../assets/images/14.jpg)"></div>
<div *ngIf ="ifs==false" class="showBanner" style="background: url(../../../assets/images/44.jpg)"></div>
<div *ngIf ="ifs2==true" class="showBanner" style="background: url(../../../assets/images/49.jpg)"></div>
  `,
  styles: [`
.mainBox .topBtn {
  position: absolute;
